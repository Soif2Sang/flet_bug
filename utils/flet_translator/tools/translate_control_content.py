...
def translate_control_content(
    TranslateFletPage_class,
    ...
    if control in TranslateFletPage_class.skiped_controls:
        return
    if control.__class__ in TranslateFletPage_class.skiped_classes:
        return
    if control == None:
        return
